...
def ztox() :
    ...
    Rhz = 1/hz
    print('\n')
    print( 'Age of the universe at z = {}        : '.format(zin), agez )
    print(  'Lookback time to z = {}              : '.format(zin), lookbacktime)
    print(  'Comoving distance to z = {}          : '.format(zin), comovingZ)
    print(  'Angular diameter distance to z = {}  : '.format(zin), dAz)
    print(  'Luminosity distance to z = {}        : '.format(zin), dLz)
    print(  'Hubble parameter at z = {}           : '.format(zin), hz)
    print(  'Hubble radius at z = {}              : '.format(zin), Rhz)
